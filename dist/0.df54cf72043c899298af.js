...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _styles = __webpack_require__(914);
  
  var _styles2 = _interopRequireDefault(_styles);
  
  var _index = __webpack_require__(925);
  
  var _GoogleSheetsRepository = __webpack_require__(920);
  
  var _GoogleSheetsRepository2 = _interopRequireDefault(_GoogleSheetsRepository);
  
  var _TransactionsTable = __webpack_require__(139);
  
  var _TransactionsTable2 = _interopRequireDefault(_TransactionsTable);
  
  var _reactChartjs = __webpack_require__(769);
  ...
  var LandLocationPage = function (_React$Component) {
    ...
    (0, _createClass3.default)(LandLocationPage, [{
      ...
      value: function componentDidMount() {
        ...
        this.landLocation = this.props.route.params.landLocation;
        this.transactionsRepository.getTransactionsForLandLocation(this.landLocation, this.repositoryCallback);
      }
    }, {
      ...
      value: function repositoryCallback(transactions) {
        ...
        var startYear = transactions[transactionCount - 1].date.substring(0, 4);
        var endYear = transactions[0].date.substring(0, 4);
  
        var labels = [];
        var salePrice = [];
        var assessedValue = [];
  
        var currentTransactionindex = transactions.length - 1;
        var currentTransaction = transactions[currentTransactionindex];
  
        for (var year = parseInt(startYear); year <= endYear; year++) {
  
          labels.push(year);
  
          if (parseInt(currentTransaction.date.substring(0, 4)) === year) {
  
            var yearlyAvgSalePrice = 0;
            var yearlySales = 0;
  
            while (currentTransaction && parseInt(currentTransaction.date.substring(0, 4)) === year) {
  
              yearlySales++;
              yearlyAvgSalePrice += parseInt(currentTransaction.price);
              currentTransactionindex--;
              currentTransaction = transactions[currentTransactionindex];
            };
  
            salePrice.push(yearlyAvgSalePrice / yearlySales);
          } else {
            salePrice.push(null);
          }
        };
  
        for (var i = transactionCount; i > 0; i--) {
        ...
        this.setState({ transactions: transactions, chartData: chartData });
      }
    }, {
      key: '_renderChart',
      value: function _renderChart() {
        if (this.state.chartData) {
          return _react2.default.createElement(_reactChartjs2.default, { data: this.state.chartData, type: 'line' });
        }
      }
    }]);
    ...
    function LandLocationPage(props) {
      ...
      _this.state = { transactions: [], chartData: [] };
      _this.transactionsRepository = new _GoogleSheetsRepository2.default();
      return _this;
    }
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _styles = __webpack_require__(915);
  
  var _styles2 = _interopRequireDefault(_styles);
  
  var _index = __webpack_require__(926);
  
  var _RmTile = __webpack_require__(422);
  
  var _RmTile2 = _interopRequireDefault(_RmTile);
  
  var _RmTransactions = __webpack_require__(423);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _RmRepository = __webpack_require__(921);
  
  var _RmRepository2 = _interopRequireDefault(_RmRepository);
  
  var _reactMdl = __webpack_require__(49);
  
  var _Detail = __webpack_require__(421);
  
  var _Detail2 = _interopRequireDefault(_Detail);
  
  var _rmTileStyles = __webpack_require__(905);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _TransactionsRepository = __webpack_require__(417);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var color = __webpack_require__(489);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  /* MIT license */
  var colorNames = __webpack_require__(492);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  /* MIT license */
  var convert = __webpack_require__(491);
  var string = __webpack_require__(488);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var conversions = __webpack_require__(490);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _chart = __webpack_require__(448);
  ...
  Core.propTypes = {
    ...
    type: _react.PropTypes.oneOf(['doughnut', 'pie', 'line', 'bar', 'radar', 'polarArea', 'bubble', 'horizontalBar']).isRequired
  };
...
/***/ function(module, exports, __webpack_require__) {
  ...
  const sheetrock = __webpack_require__(208);
  ...
  module.exports = class GoogleSheetsRepository {
  
    constructor() {
      this.searchTransactions = debounce(this.searchTransactions, 500);
  		this.transactionStore = [];
    }
  
  	isRmSearch(searchTerm) {
  	...
  	isNumericSearch(searchTerm) {
  		...
  		return searchTerm.match(regex) !== null;
  	};
  
  	isLandLocationSearch(searchTerm) {
  
  		var regex = new RegExp(/[^-\s]{1,2}/);
  	...
  	stringContains(str, contains) {
  
  		var containsRegex = new RegExp("^.*" + contains + ".*$", "i");
  
  		return str.match(containsRegex) !== null;
  	};
  
    searchTransactions(searchTerm, callback) {
  
  		console.log("Searching: " + searchTerm);
  
  		if (this.transactionStore.length === 0) {
  
  			var query = "select * where date '2010-1-1' < I order by I desc"
  			console.log(query);
  
  			var that = this;
  
  			var filterCallback = function () {
  				that.filterTransactions(searchTerm, callback)
  			};
  
  			this.getTransactionsWithSheetRock(query, filterCallback);
  		}	else {
  
  			this.filterTransactions(searchTerm, callback);
  		};
    };
  
  	filterTransactions(searchTerm, callback) {
  
  		var isRmSearchTerm = this.isRmSearch(searchTerm);
  		var isNumericSearchTerm = this.isNumericSearch(searchTerm);
  		var isLandLocationSearchTerm = this.isLandLocationSearch(searchTerm);
  		var isNameSearchTerm = this.isNameSearch(searchTerm);
  
  		var results = [];
  
  		for (var i = 0; i < this.transactionStore.length; i++) {
  			var currentTransaction = this.transactionStore[i];
  			var alreadyAdded = false;
  
  			// Check if RM
  			if (!alreadyAdded && isRmSearchTerm) {
  				if (this.stringContains(currentTransaction.rm, searchTerm)) {
  			...
  			if (!alreadyAdded && isNumericSearchTerm) {
  				if (this.stringContains(currentTransaction.price, searchTerm) ||
  						this.stringContains(currentTransaction.perAcre, searchTerm) ||
  						this.stringContains(currentTransaction.acres, searchTerm)) {
  					results.push(currentTransaction);
  					alreadyAdded = true;
  				}
  			}
  
  			// Check if Land landLocation
  			if (!alreadyAdded && isLandLocationSearchTerm) {
  				if (this.stringContains(currentTransaction.landLocation, searchTerm)) {
  					results.push(currentTransaction);
  					alreadyAdded = true;
  				}
  			}
  			...
  			// Check if name
  			if (!alreadyAdded && isNameSearchTerm) {
  				if (this.stringContains(currentTransaction.buyer, searchTerm) ||
  						this.stringContains(currentTransaction.seller, searchTerm)) {
  					results.push(currentTransaction);
  					alreadyAdded = true;
  				}
  			}
  		...
  		getTransactionsForLandLocation(landLocation, callback) {
  
  			var query = "select * where A = '" + landLocation + "' order by I desc"
  		...
  		function mapRowToTransaction(row) {
  			...
  			var transaction = {};
  			transaction.landLocation = row.cellsArray[0];
  			transaction.rm = row.cellsArray[1];
  			transaction.soil = row.cellsArray[2];
  			transaction.acres = row.cellsArray[4];
  			transaction.price = row.cellsArray[5];
  			transaction.perAcre = row.cellsArray[6];
  			transaction.assessedValue = row.cellsArray[7];
  			transaction.date = row.cellsArray[8];
  			transaction.seller = row.cellsArray[9];
  			transaction.buyer = row.cellsArray[10];
  		...
  		var customCallback = function(error, options, response) {
  			...
  			var getTransactionArray = function(rows) {
  
  				var transactions = [];
  
  				for (var i = 1; i < rows.length; i++) {
  						var transaction = mapRowToTransaction(rows[i]);
  			...
  			this.transactionStore = getTransactionArray(response.rows)
  
  			callback(this.transactionStore);
  		};
  
  		sheetrock({
  			url: "https://docs.google.com/spreadsheets/d/13GATSXOqc_PSbvXmeTeapPJM6wIpJMG-qLxMNrYMIdU/edit#gid=0",
  			query: query,
